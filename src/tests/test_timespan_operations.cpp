...
BOOST_AUTO_TEST_SUITE(test_timespan_operations)

BOOST_AUTO_TEST_CASE(test_format_timespan_seconds)
{
...
BOOST_AUTO_TEST_CASE(test_format_timespan_minutes)
{
	using namespace std::chrono_literals;
...
BOOST_AUTO_TEST_CASE(test_format_timespan_hours)
{
	using namespace std::chrono_literals;
...
BOOST_AUTO_TEST_CASE(test_format_timespan_days)
{
...
BOOST_AUTO_TEST_CASE(test_format_timespan_weeks)
{
...
BOOST_AUTO_TEST_CASE(test_format_timespan_years)
{
...
BOOST_AUTO_TEST_CASE(test_format_timespan_zero)
{
	using namespace std::chrono_literals;
...
BOOST_AUTO_TEST_CASE(test_format_timespan_complex)
{
	using namespace std::chrono_literals;
...
BOOST_AUTO_TEST_CASE(test_format_timespan_days_hours)
{
	using namespace std::chrono_literals;
...
BOOST_AUTO_TEST_CASE(test_format_timespan_years_weeks)
{
...
BOOST_AUTO_TEST_CASE(test_format_timespan_years_months_hours)
{
...
BOOST_AUTO_TEST_CASE(test_format_timespan_months_seconds)
{
